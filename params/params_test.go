...
func generateInitParams(t *testing.T, r *rand.Rand) *params.VersionedGlobalParams {
	var pks []string
	...
	gp := params.VersionedGlobalParams{
		Version:           0,
		ActivationHeight:  0,
...
func genValidGlobalParam(
	...
	if num == 1 {
		return &params.GlobalParams{
			Versions: []*params.VersionedGlobalParams{initParams},
		}
	}

	var versions []*params.VersionedGlobalParams
...
func FuzzParseValidParams(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, seed int64) {
		...
		parsedParams, err := params.ParseGlobalParams(globalParams)
		require.NoError(t, err)
